...
function completeHandler(event)
{
    ...
    else
    {
        if ((strpath.search('.mp4') > 0))
        {
            content += "<video class='embed' width='50%' height='50%' controls><source src='"+strpath+"'></video>&nbsp;<abbr title='For Internet Explorer, right-click on the play button and select play/pause'><span class='glyphicon glyphicon-question-sign'></span></abbr><br>";
        }
        else if ((strpath.search('.mp3') > 0))
        {
