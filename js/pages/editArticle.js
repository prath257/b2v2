...
function showPreview()
{
	...
	if($('#postForm').data('bootstrapValidator').isValid() && title.length > 0 && ifc.length > 0)
	{
...
function saveArticle(said)
{
    ...
    $('#updatingMsg').show();
	$.post('http://localhost/b2v2/editArticle', {id: said, title: title, category: category, ifc: ifc, description: desc, content: content}, function(message)
	{
