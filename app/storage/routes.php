...
//mobile controller
Route::post('mobile_fblogin', array('uses' => 'MobileController@fblogin'));
Route::post('mobile_login', array('uses' => 'MobileController@login'));
Route::post('mobile_tlogin', array('uses' => 'MobileController@tlogin'));
Route::post('mobile_glogin', array('uses' => 'MobileController@glogin'));
