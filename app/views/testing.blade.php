...
<head>
    ...
    <!--css includes.-->
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link rel="stylesheet" href="{{asset('css/plugins/font.css')}}" />
        <link rel="stylesheet" href="{{asset('css/plugins/picedit.css')}}" />

</head>
<!--on hovering anywhere on the page, the default text 'Be-Barters is a social shaing website...' is shown.-->
<body>
<!-- begin_picedit_box this is the final container resize it the way you want it -->

{{ Form::open(array('url' => 'savePP','files'=>true)) }}
...
<script src="../../js/plugins/picedit.js"></script>
<script src="{{asset('js/pages/testing.js')}}"></script>
</body>
</html>