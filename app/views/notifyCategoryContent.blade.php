...
@foreach($blogbooks as $book)
    <li style="list-style-type: none">
        <div>
            <img style="float: left" src="{{$book->getAuthor->profile->profilePic}}" width="30px" height="30px">
    ...
    <li style="list-style-type: none">
        <div>
            <img style="float: left" src="{{$article->getAuthor->profile->profilePic}}" width="30px" height="30px">
    ...
    @foreach($resources as $resource)
        <li style="list-style-type: none">
            <div>
                <img style="float: left" src="{{$resource->getAuthor->profile->profilePic}}" width="30px" height="30px">
