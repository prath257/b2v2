...
<?php
                                                             ...
                                                             $recDesc = str_replace('\"','', $recDesc);
                                             ?>
                                                <div class="col-lg-12" style="padding: 0px"><a style="cursor: pointer" onclick="reccoThis('http://b2.com/resource/{{$book->id}}','{{$recTitle}}','{{$recDesc}}','http://b2.com/Images/Resource.jpg')">Recommend this to Barters</a></div>
