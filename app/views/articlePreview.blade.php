    ...
    <div class="col-lg-12">
        <div class="col-lg-4" style="margin-top: 50px">
            <?php
                 ...
                 $recDesc = str_replace('"','', $recDesc);
            ?>
            <p style="word-wrap: break-word; font-family: 'Haettenschweiler'; text-transform: uppercase; font-size: 50px">{{Str::limit($book->title,50)}} <img src="http://b2.com/Images/recco this.PNG" style="cursor: pointer" onclick="reccoThis('http://b2.com/articlePreview/{{$book->id}}','{{$recTitle}}','{{$recDesc}}','{{$book->cover}}')"></p>
            ...
            <div class="col-lg-9" style="padding-top: 10px">
                ...
                <div class="col-lg-12" style="padding: 0px; margin-top: 25px">
                    ...
                    @if (Auth::check())
                                    ...
                                    @if(Auth::user()->id == $book->userid || $book->isReader())

                                        <a href="{{route('article',$book->id)}}" class="col-lg-4 btn btn-success">Read</a>
                                     ...
                                     @endif
                                      ...
                                      <div class="col-lg-3">
                                                    <div class="fb-share-button" style="padding: 5px" data-href="http://b2.com/articlePreview/{{$book->id}}"></div><br>
                                                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://b2.com/articlePreview/{{$book->id}}" data-text="Check this out" data-count="none" data-hashtags="bbarters" style="margin-top: 2px">Tweet</a>
