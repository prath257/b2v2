...
<html>
<head>
    <title>Respond to Bug | BBarters</title>
...
<input type="hidden" id="bugId" value="{{$bug}}">
...
<div class="modal fade" id="respondToBugModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Respond To Bug</h4>
            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-9 col-lg-offset-3">
                                <button id="postButton" type="button" class="btn btn-primary" onclick="postResponse()">Submit</button>
                            </div>
                        </div>
    ...
    <div class="form-group" style="margin-top: 30px; text-align: center;" >
        ...
        <?php $b=DB::table('reportbug')->where('id',$bug)->first() ?>
        {{   $b->text;  }}
    </div>
