...
<head>
    ...
    <link href="{{asset('css/pages/soccerAdmin.css')}}" rel="stylesheet">
      	...
      	<div class="modal-dialog">
      		<div class="modal-content">
      			<div class="modal-header">
      				...
      				<h4 class="modal-title" id="scorerModalTitle">So who all have scored:</h4>
      			</div>
...
<script src="{{asset('js/pages/soccerAdmin.js')}}"></script>
</body>
</html>