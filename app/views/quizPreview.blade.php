                    ...
                    @if (Auth::check())
                                     ...
                                     @endif
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://b2.com/quizPreview/{{$book->id}}" data-text="Check this out" data-count="none" data-hashtags="bbarters" style="margin-top: 2px">Tweet</a>
...
<input id="type" name="type" type="hidden" value="quiz">
