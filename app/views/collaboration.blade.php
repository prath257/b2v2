...
<div style="width: 100%" onmousedown='return false;' onselectstart='return false;'>
    ...
    &nbsp;<div class="fb-share-button" data-href="http://b2.com/collaborationPreview/{{$collaboration->id}}"></div>
        <br><br>
    <div class="social" style="padding-top: 3%">
	<div style="float: left">
        <div class="fb-send" data-href="http://b2.com/collaborationPreview/{{$collaboration->id}}" data-colorscheme="light"></div>
        &nbsp;
    </div>
	<div>
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://b2.com/collaborationPreview/{{$collaboration->id}}" data-text="Check this out" data-count="none" data-hashtags="bbarters">Tweet</a>
    ...
    <div id="Content">
        ...
        <div>
            ...
            <div class="fb-comments" data-href="http://b2.com/collaborationPreview/{{$collaboration->id}}" data-width="600" data-numposts="10" data-colorscheme="light"></div>
        </div>
    </div>
