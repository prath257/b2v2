...
<html>
<head>
    <title>New Chapter | {{$collaboration->title}} | BBarters</title>
...
<div id="preview" class="col-lg-10 col-lg-offset-1">
    ...
    <div class="pull-right">
        <button id="saveEditButton" type="button" class="btn btn-primary" onclick="saveChapter({{$collaboration->id}})">OK! Looks cool</button>
...
<div class="summernote col-lg-12">
    <div class="col-lg-6">
        <p class="col-lg-12" style="color: blue; font-size: 24px; margin-bottom: 0px"><i>{{$collaboration->title}}</i></p>
        <p class="col-lg-12" style="margin-top: 0px; margin-bottom: 0px; font-size: 24px">New Chapter:</p>
    </div>
        ...
        <form class="form-horizontal" id="postForm">
            <fieldset>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="col-lg-12">
                        <input type="text" id="title" class="form-control" name="title" placeholder="Chapter Name" onkeyup="checkTitle()" autocomplete="off" />
                    </div>
                ...
                <div class="col-lg-9">
                    ...
                    <a id="cancel" class="btn btn-default" href="{{route('collaborationsDashboard')}}">Cancel</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <fieldset>
                    ...
                    <p>Your chapter for '{{$collaboration->title}}' has been successfully posted.</p>
                    @else
                    <p>Your chapter for '{{$collaboration->title}}' has been sent to the owner for approval.</p>
                    @endif
                    <button type="button" class="btn btn-primary pull-right" aria-hidden="true" onclick="anotherChapter({{$collaboration->id}})">Write another Chapter</button>
...
<script src="{{asset('js/pages/collaborationNewChapter.js')}}"></script>
