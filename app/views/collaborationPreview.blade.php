...
<?php
                                                             ...
                                                             $recDesc = str_replace('\"','', $recDesc);
                                             ?>
                                                <div class="col-lg-12" style="padding: 0px"><a style="cursor: pointer" onclick="reccoThis('http://b2.com/collaborationPreview/{{$book->id}}','{{$recTitle}}','{{$recDesc}}','{{$book->cover}}')">Recommend this to Barters</a></div>
                            @else
