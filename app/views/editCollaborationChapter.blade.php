...
<html>
<head>
    <title>Edit Chapter | {{$collaboration->title}} | BBarters</title>
...
<div id="preview" class="col-lg-10 col-lg-offset-1">
    ...
    <div class="pull-right">
        <button id="saveEditButton" type="button" class="btn btn-primary" onclick="saveChapter({{$chapter->id}},{{$chapter->getCollaboration->userid}})">OK! Looks cool</button>
...
<div class="summernote col-lg-12">
    <div class="col-lg-6">
        ...
        <p class="col-lg-12" style="margin-top: 0px; margin-bottom: 10px; font-size: 24px">Edit Chapter: <i>{{$chapter->title}}</i></p>
    </div>
        ...
        <form class="form-horizontal" id="postForm">
            <fieldset>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="col-lg-12">
                        <input type="text" id="title" class="form-control" name="title" value="{{$chapter->title}}" placeholder="Chapter Name" onkeyup="checkTitle()" autocomplete="off" />
                    </div>
                </div>
...
<input type="hidden" id="collaborationId" value="{{$chapter->getCollaboration->id}}">

<input type="hidden" id="refreshed" value="no">
<script src="{{asset('js/reload.js')}}"></script>

<script src="{{asset('js/bootstrapValidator.min.js')}}"></script>
<script src="{{asset('js/pages/editCollaborationChapter.js')}}"></script>
